...
public class SpazioTorreGialla4 extends JPanel{
	...
	public SpazioTorreGialla4() {
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Gialla\\4\\north.png");
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Gialla\\4\\east.png");
		image = imageIcon.getImage();
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Gialla\\4\\west.png");
		image = imageIcon.getImage();
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Gialla\\4\\center.png");
		image = imageIcon.getImage();
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Gialla\\4\\south.png");
		image = imageIcon.getImage();
		...
		buttonEast.setActionCommand("spazioTorreGialla4");
