...
public class SpazioTorreViola1 extends JPanel{
	...
	public SpazioTorreViola1() {
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Viola\\1\\center.png");
		image = imageIcon.getImage();
		...
		buttonEast.setActionCommand("spazioTorreViola1");
