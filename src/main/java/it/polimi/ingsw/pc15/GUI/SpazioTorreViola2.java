...
public class SpazioTorreViola2 extends JPanel{
	...
	public SpazioTorreViola2(String path, ActionListener listener) {
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Viola\\2\\north.png");
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Viola\\2\\east.png");
		image = imageIcon.getImage();
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Viola\\2\\west.png");
		image = imageIcon.getImage();
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Viola\\2\\south.png");
		image = imageIcon.getImage();
		...
		buttonFamiliare = new ButtonTransparent("spazioTorreViola2",160,160,listener);
