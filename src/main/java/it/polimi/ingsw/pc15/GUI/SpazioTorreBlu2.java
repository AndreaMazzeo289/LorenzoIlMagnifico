...
public class SpazioTorreBlu2 extends JPanel{
	...
	public SpazioTorreBlu2() {
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Blu\\2\\north.png");
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Blu\\2\\east.png");
		image = imageIcon.getImage();
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Blu\\2\\west.png");
		image = imageIcon.getImage();
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Blu\\2\\center.png");
		image = imageIcon.getImage();
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Blu\\2\\south.png");
		image = imageIcon.getImage();
		...
		buttonEast.setActionCommand("spazioTorreBlu2");
