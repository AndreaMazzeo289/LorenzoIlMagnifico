...
public class SpazioTorreBlu3 extends JPanel{
	...
	public SpazioTorreBlu3() {
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Blu\\3\\north.png");
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Blu\\3\\east.png");
		image = imageIcon.getImage();
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Blu\\3\\west.png");
		image = imageIcon.getImage();
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Blu\\3\\center.png");
		image = imageIcon.getImage();
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Blu\\3\\south.png");
		image = imageIcon.getImage();
		...
		buttonEast.setActionCommand("spazioTorreBlu3");
