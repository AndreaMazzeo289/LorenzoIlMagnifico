...
public class SpazioTorreViola3 extends JPanel{
	...
	public SpazioTorreViola3(String path, ActionListener listener) {
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Viola\\3\\north.png");
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Viola\\3\\east.png");
		image = imageIcon.getImage();
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Viola\\3\\west.png");
		image = imageIcon.getImage();
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Viola\\3\\south.png");
		image = imageIcon.getImage();
		...
		buttonFamiliare = new ButtonTransparent("spazioTorreViola3",160,160,listener);
