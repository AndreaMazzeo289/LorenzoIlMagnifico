...
public class SpazioTorreGialla2 extends JPanel{
	...
	public SpazioTorreGialla2(String path, ActionListener listener) {
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Gialla\\2\\north.png");
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Gialla\\2\\east.png");
		image = imageIcon.getImage();
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Gialla\\2\\west.png");
		image = imageIcon.getImage();
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Gialla\\2\\south.png");
		image = imageIcon.getImage();
		...
		buttonFamiliare = new ButtonTransparent("spazioTorreGialla2",160,160,listener);
