...
public class CestaLegna extends JPanel{
	...
	public CestaLegna() {
		...
		imageIcon = new ImageIcon("img\\Punchboard\\legna\\north.png");
		...
		imageIcon = new ImageIcon("img\\Punchboard\\legna\\east.png");
		image = imageIcon.getImage();
		...
		imageIcon = new ImageIcon("img\\Punchboard\\legna\\west.png");
		image = imageIcon.getImage();
		...
		imageIcon = new ImageIcon("img\\Punchboard\\legna\\center.png");
		image = imageIcon.getImage();
		...
		imageIcon = new ImageIcon("img\\Punchboard\\legna\\south.png");
		image = imageIcon.getImage();
