...
public class SpazioTorreViola4 extends JPanel{
	...
	public SpazioTorreViola4() {
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Viola\\4\\north.png");
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Viola\\4\\east.png");
		image = imageIcon.getImage();
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Viola\\4\\west.png");
		image = imageIcon.getImage();
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Viola\\4\\center.png");
		image = imageIcon.getImage();
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Viola\\4\\south.png");
		image = imageIcon.getImage();
		...
		buttonEast.setActionCommand("spazioTorreViola4");
