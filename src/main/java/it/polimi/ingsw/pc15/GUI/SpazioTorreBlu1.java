...
public class SpazioTorreBlu1 extends JPanel{
	...
	public SpazioTorreBlu1() {
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Blu\\1\\north.png");
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Blu\\1\\east.png");
		image = imageIcon.getImage();
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Blu\\1\\west.png");
		image = imageIcon.getImage();
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Blu\\1\\center.png");
		image = imageIcon.getImage();
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Blu\\1\\south.png");
		image = imageIcon.getImage();
		...
		buttonEast.setActionCommand("spazioTorreBlu1");
