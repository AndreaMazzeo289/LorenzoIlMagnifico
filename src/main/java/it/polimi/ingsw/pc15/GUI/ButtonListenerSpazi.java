...
public class ButtonListenerSpazi implements ActionListener {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(arg0.getActionCommand().equals("spazioTorreVerde2"))
			((Gameboard)mainGUI.mainFrame.getContentPane().getComponent(0)).getSpazioTorreVerde2().inserisciFamiliare("img/Punchboard/familiari/familiariSpazi/BA.png");
		
		if(arg0.getActionCommand().equals("spazioTorreVerde3"))
			((Gameboard)mainGUI.mainFrame.getContentPane().getComponent(0)).getSpazioTorreVerde3().inserisciFamiliare("img/Punchboard/familiari/familiariSpazi/BA.png");
		
		if(arg0.getActionCommand().equals("spazioTorreVerde4"))
			((Gameboard)mainGUI.mainFrame.getContentPane().getComponent(0)).getSpazioTorreVerde4().inserisciFamiliare("img/Punchboard/familiari/familiariSpazi/BA.png");
		
		//------------------------------------------------------------------------------------------//
		// SPAZI TORRE BLU
		//------------------------------------------------------------------------------------------//
		if(arg0.getActionCommand().equals("spazioTorreBlu1"))
			((Gameboard)mainGUI.mainFrame.getContentPane().getComponent(0)).getSpazioTorreBlu1().inserisciFamiliare("img/Punchboard/familiari/familiariSpazi/BA.png");
		
		if(arg0.getActionCommand().equals("spazioTorreBlu2"))
			((Gameboard)mainGUI.mainFrame.getContentPane().getComponent(0)).getSpazioTorreBlu2().inserisciFamiliare("img/Punchboard/familiari/familiariSpazi/BA.png");
		
		if(arg0.getActionCommand().equals("spazioTorreBlu3"))
			((Gameboard)mainGUI.mainFrame.getContentPane().getComponent(0)).getSpazioTorreBlu3().inserisciFamiliare("img/Punchboard/familiari/familiariSpazi/BA.png");
		
		if(arg0.getActionCommand().equals("spazioTorreBlu4"))
			((Gameboard)mainGUI.mainFrame.getContentPane().getComponent(0)).getSpazioTorreBlu4().inserisciFamiliare("img/Punchboard/familiari/familiariSpazi/BA.png");
		
		//------------------------------------------------------------------------------------------//
		// SPAZI TORRE VIOLA
		//------------------------------------------------------------------------------------------//
		if(arg0.getActionCommand().equals("spazioTorreViola1"))
			((Gameboard)mainGUI.mainFrame.getContentPane().getComponent(0)).getSpazioTorreViola1().inserisciFamiliare("img/Punchboard/familiari/familiariSpazi/BA.png");
		
		if(arg0.getActionCommand().equals("spazioTorreViola2"))
			((Gameboard)mainGUI.mainFrame.getContentPane().getComponent(0)).getSpazioTorreViola2().inserisciFamiliare("img/Punchboard/familiari/familiariSpazi/BA.png");
		
		if(arg0.getActionCommand().equals("spazioTorreViola3"))
			((Gameboard)mainGUI.mainFrame.getContentPane().getComponent(0)).getSpazioTorreViola3().inserisciFamiliare("img/Punchboard/familiari/familiariSpazi/BA.png");
		
		if(arg0.getActionCommand().equals("spazioTorreViola4"))
			((Gameboard)mainGUI.mainFrame.getContentPane().getComponent(0)).getSpazioTorreViola4().inserisciFamiliare("img/Punchboard/familiari/familiariSpazi/BA.png");
				
		//------------------------------------------------------------------------------------------//
		// SPAZI TORRE GIALLA
		//------------------------------------------------------------------------------------------//
		if(arg0.getActionCommand().equals("spazioTorreGialla1"))
			((Gameboard)mainGUI.mainFrame.getContentPane().getComponent(0)).getSpazioTorreGialla1().inserisciFamiliare("img/Punchboard/familiari/familiariSpazi/BA.png");
		
		if(arg0.getActionCommand().equals("spazioTorreGialla2"))
			((Gameboard)mainGUI.mainFrame.getContentPane().getComponent(0)).getSpazioTorreGialla2().inserisciFamiliare("img/Punchboard/familiari/familiariSpazi/BA.png");
		
		if(arg0.getActionCommand().equals("spazioTorreGialla3"))
			((Gameboard)mainGUI.mainFrame.getContentPane().getComponent(0)).getSpazioTorreGialla3().inserisciFamiliare("img/Punchboard/familiari/familiariSpazi/BA.png");
		
		if(arg0.getActionCommand().equals("spazioTorreGialla4"))
			((Gameboard)mainGUI.mainFrame.getContentPane().getComponent(0)).getSpazioTorreGialla4().inserisciFamiliare("img/Punchboard/familiari/familiariSpazi/BA.png");
		...
		if(arg0.getActionCommand().equals("spazioProduzione1")){
			...
			spazioProduzione1.inserisciFamiliare("img/Punchboard/familiari/familiariSpazi/BA.png");
		}
		...
		if(arg0.getActionCommand().equals("spazioRaccolto1")){
			...
			spazioRaccolto1.inserisciFamiliare("img/Punchboard/familiari/familiariSpazi/BA.png");
		}
		...
		if(arg0.getActionCommand().equals("spazioMercato1"))
			((Gameboard)mainGUI.mainFrame.getContentPane().getComponent(0)).getSpazioMercato1().inserisciFamiliare("img/Punchboard/familiari/familiariSpazi/BA.png");
		
		if(arg0.getActionCommand().equals("spazioMercato2"))
			((Gameboard)mainGUI.mainFrame.getContentPane().getComponent(0)).getSpazioMercato2().inserisciFamiliare("img/Punchboard/familiari/familiariSpazi/BA.png");
		
		if(arg0.getActionCommand().equals("spazioMercato3"))
			((Gameboard)mainGUI.mainFrame.getContentPane().getComponent(0)).getSpazioMercato3().inserisciFamiliare("img/Punchboard/familiari/familiariSpazi/BA.png");
		
		if(arg0.getActionCommand().equals("spazioMercato4"))
			((Gameboard)mainGUI.mainFrame.getContentPane().getComponent(0)).getSpazioMercato4().inserisciFamiliare("img/Punchboard/familiari/familiariSpazi/BA.png");
	}
