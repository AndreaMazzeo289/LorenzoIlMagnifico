...
public class SpazioTorreVerde3 extends JPanel{
	...
	public SpazioTorreVerde3() {
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Verde\\3\\north.png");
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Verde\\3\\east.png");
		image = imageIcon.getImage();
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Verde\\3\\west.png");
		image = imageIcon.getImage();
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Verde\\3\\center.png");
		image = imageIcon.getImage();
		...
		imageIcon = new ImageIcon("img\\Gameboard\\SpaziTorre\\Verde\\3\\south.png");
		image = imageIcon.getImage();
		...
		buttonEast.setActionCommand("spazioTorreVerde3");
