...
public class TestTerritorio {
	...
	public void setUp(){
		...
		cartaTerritorio = new Territorio("Carta", 1, 1, setRisorse, effettoIstantaneo, effettoPermanente, 3, "test");
	...
	public void testGetRequisitoProduzione(){
		assertEquals("Errore test get requisito produzione", 3, cartaTerritorio.getRequisitoRaccolta());
	}
}
